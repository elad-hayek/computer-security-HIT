  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.note}>
          🔴 VULNERABLE: SessionId only in localStorage (spoofable). No
          server-side session validation. Stored XSS in customer names - try
          entering: &lt;img src=x onerror="alert('XSS')"&gt;
        </p>
      </div>
    </div>
  );
